...
<script>
  ...
  import ChartPage from './components/ChartPage.svelte'
  import DataFormPage from './components/DataFormPage.svelte'
  import GaugePage from './components/GaugePage.svelte'
  import AutoCompletePage from './components/AutoCompletePage.svelte'
